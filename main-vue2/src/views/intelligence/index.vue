<template>
  <div style="height:100%;display: flex;">
    ...
    <micro-app style="height:100%;width: 500px;border: 1px solid red;" name='intelligence' :url='microUrl'
      baseroute='/intelligence' inline disable-memory-router :data='microAppData' @created='handleCreate'
